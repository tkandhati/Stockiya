...
def render_picks_response(
    ...
    early_signals: Optional[list[dict]] = None,
    ready_to_break: Optional[list[dict]] = None,
) -> dict:
    ...
    if early_signals:
        response["early_signals"] = early_signals
    if ready_to_break:
        response["ready_to_break"] = ready_to_break
    return response
